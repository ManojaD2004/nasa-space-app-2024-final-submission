...
import { BackgroundGradient } from "@/app/components/Background";
import { instrumentValuesDesc } from "@/data/exoPlanetValuesDesc.js";
  ...
  return (
    <div className="bg-white">
      <p className="text-black px-[40px] pt-[50px] text-[50px]">
        <span className={poppinsFont1.className}>
          Instrument Terminologies:
        </span>
      </p>
